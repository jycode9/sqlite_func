...
public:
	...
	//查找：全部查找
	int selectData1(const char* tablename, std::vector<std::map<std::string, std::string>>& calldatas);
	////查找：where索引全部查找
...
/*
int sqlfunc::selectData(const char* tablename, std::vector<std::map<std::string, std::string>>& calldatas) {
